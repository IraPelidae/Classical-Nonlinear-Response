...
const int no_samples = 600; //number of simulation runs (i.e. sample size)
const float max_time = 3; //max time to which system evolves
const float sampling_time = 1; //sampling time period
...
const double V = 1;
const double kick_width = 1;

//Exporting + Directory
const bool export_v = false;
const std::string folder_name = "24_09_VelocityKicks"; //Name of directory in which you store data file
